      ...
      <div className="grid grid-cols-1 lg:grid-cols-[8.5fr_3.5fr] gap-8 mt-6">
        <div className="grid grid-cols-1 antialiased gap-6 text-white/80 text-xl md:text-2xl">
          ...
          <AnimatedBody className="leading-[34px] md:leading-[39px]">
            ...
            Frontend Developer on the way & solving complex challenges increasing the
          ...
          <AnimatedBody className="inline leading-[34px] md:leading-[39px]">
            ...
            <button className="border-4 rounded-2xl px-1.5">

            <Link
              className=""
              href={
                "https://drive.google.com/file/d/1yiCQl0sXvvwBIHYY6o-otIMIcy7ecR1s/view"
              }
            >
               My Resume
            </Link>
        ...
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <AnimatedBody className="text-white/60 text-base md:text-xl leading-8">
              JavaScript(ES6+), React,Basic Next.js, Redux, Redux
